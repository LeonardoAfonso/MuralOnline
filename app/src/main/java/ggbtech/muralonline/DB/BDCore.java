...
/*
    ...
    @Override
    public void onCreate(SQLiteDatabase bd) {
        bd.execSQL("create table aviso(_id integer primary key autoincrement, imagem int not null ,titulo text not null, evento text not null, local text not null, data text null, datafinal text null, hora text null" +
                ", horafinal text null , observacao text null, contato text null);");
    }
